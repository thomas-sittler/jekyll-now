...
> _The irrelevant conjunction paradox._ Suppose that $$e$$
 onfirms $$h$$ relative to (possibly empty) $$k$$. Let statement $$q$$
 ...
 ant to say no, and this implication can be suitably reconstructed in
 empel&rsquo;s theory. HD-confirmation, on the contrary, can not draw
 his distinction: it is easy to show that, on the conditions
 pecified, if the HD clause for confirmation is satisfied for $$e$$
 nd $$h$$ (given $$k$$), so it is for $$e$$ and $$h\wedge q$$ (given
...
It's easy to check that Hempel's instance confirmation successfully avoids the paradox or irrelevant conjunction.
