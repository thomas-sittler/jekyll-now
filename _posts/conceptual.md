...
So, in our brains, category membership is a matter of degree, and with some typical members, some atypical members, and some fringe items for which our membership-intuition fluctuates. You might think that this is not a problem for conceptual analysis. We simply need a more sophisticated notion of conceptual analysis, one that admits of degree. 

# Conceptual analysis that admits of degree
